#!/bin/bash
# range n from 1M to 128M, doubling each time

# Loop through the values from 1M to 128M, doubling each time
for ((N=1*1000000; N<=128*1000000; N*=2))
do
    ...
    report="synthetic_report_full.txt"
